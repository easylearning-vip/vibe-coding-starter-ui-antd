...
// 初始化日志系统
const logConfig = initializeLogConfig();
logger.updateConfig(logConfig);
logger.info('Application starting...', { config: logConfig });
...
export async function getInitialState(): Promise<{
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      logger.debug('Token found, fetching user data');
      ...
      logger.error(
        'Failed to fetch user info, clearing token',
        _error as Error,
      );
      // 清除无效的 token
